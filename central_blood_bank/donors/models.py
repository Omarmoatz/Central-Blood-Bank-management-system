...
class Donor(models.Model):
    ...
    blood_type = models.CharField(choices=BloodTypeChoices.choices, max_length=3)
...
class BloodStock(models.Model):
    ...
    donor = models.ForeignKey(Donor, on_delete=models.CASCADE, related_name='blood_stocks')
